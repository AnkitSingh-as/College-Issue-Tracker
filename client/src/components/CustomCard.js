    ...
    <Card sx={{ maxWidth: 360, minWidth: 360, borderRadius: '10px' }}>
      <Box sx={{
        ...
        <Box sx={{ display: 'flex', height: '70px', alignItems: 'center', justifyContent: 'center', }}>
          <Box sx={{
            height: '30px', width: '30px', borderRadius: '100px', margin: '15px',
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '10px' }}>
          <Box sx={{
            height: 'max-content', padding: '2px 3px 2px 3px',
      ...
      <CardMedia
        ...
        alt="issue image"
      />
      <CardContent sx={{padding: '16px 0px 16px 16px'}}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'row' , margin:'1px 0 1px 0'}}>
